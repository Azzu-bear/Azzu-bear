...
| [**Sluggers of the Lost Goal**](https://github.com/Azzu-bear/sluggers-of-the-lost-goal) | Autonomous ball shooting robot, built in five weeks on a $200 budget for a mechatronics competition. Two processors: a pic32 running the hierarchical state machines, and an esp32-c3 fanning eight vl53l1x time of flight sensors out behind an i2c mux and streaming sweeps over uart. Shipped with a fixed flywheel speed rather than live lidar ranging, because one bad return in the seconds before a shot cost more than the adaptivity was worth. |
